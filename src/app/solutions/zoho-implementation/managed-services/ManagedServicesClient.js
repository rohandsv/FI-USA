...
const serviceAreas = [
  ...
  },
  {
    ...
    covers: "One US based account lead who knows your system, attends your quarterly review, owns the relationship, and is the escalation path for anything outside everyday support. Having a dedicated expert means you never have to repeat your business logic to a new consultant. Your account lead acts as a Zoho architect, ensuring every change we make is architecturally sound and scales with your future growth plans."
  },
  {
    area: "Security & Access Reviews",
    covers: "Periodic role and permission audits, user access hygiene, and API key / integration credential rotation support. As your team grows and changes, security gaps naturally emerge. Our managed zoho services include regular security checkups to ensure that the right people have the right access to the right data. We help you stay compliant with internal security policies and industry best practices like SOC 2."
  }
];
...
const tiers = [
  ...
  { feature: "Security & access review", essential: "Annual", professional: "Semiannual", enterprise: "Quarterly" },
...
const slas = [
  ...
  { severity: "P3 — Minor issue / request", definition: "Noncritical config request, report update, minor field change.", essential: "5 business days", professional: "3 business days", enterprise: "2 business days" }
];

const onboardingSteps = [
  { step: "Fit call", timing: "Before contract", what: "We review your current Zoho setup, understand your admin load and backlog, and recommend the right retainer tier. No pitch deck, just honest scoping focused on managed zoho services ROI." },
  { step: "System audit & handover", timing: "Weeks 1 to 2", what: "We document your system, including modules, integrations, workflows, user roles, and known issues, and take ownership of the admin stack from whoever managed it previously." },
...
const faqs = [
  ...
  { q: "What SLA does FI Digital offer for incident response?", a: "SLA response times are tiered by retainer level. P1 business critical incidents: next business day (Essential), 4 hours (Professional), 2 hours (Enterprise). Our zoho admin support is optimized for US business hours: Monday to Friday, 9am to 6pm ET." },
  { q: "Can I use monthly hours for new features or enhancements?", a: "Yes. Monthly hours can be applied to admin tasks, incident response, user support, and small enhancements. Larger enhancements, such as new module implementations, Zoho Creator app builds, or complex new integrations, are scoped separately. This is a key benefit of managed zoho services." },
  ...
  { q: "What Zoho modules does the retainer cover?", a: "All Zoho modules, including CRM, Desk, Books, People, Analytics, Creator, Campaigns, Projects, Inventory, Zoho One, and more. The modules in scope are defined and documented during the onboarding system audit, ensuring comprehensive zoho crm maintenance." },
    ...
    <div ref={containerRef}>
        ...
        <div className={`container ${homeStyles.heroContainer}`}>
          <div className={homeStyles.heroContent}>
            ...
            <div className={`hero-animate ${homeStyles.heroCtas}`}>
              <Link href="/book-a-fit-call/?practice=zoho-managed" className="btn btn-primary">Book a fit call &#8594;</Link>
              <Link href="/packages/#zoho-managed-services" className="btn btn-secondary">See retainer pricing &#8594;</Link>
            </div>
          </div>
        </div>
      ...
      <section className={`${homeStyles.sectionAbout} scroll-section`} style={{ padding: '10rem 0' }}>
        <div className="container">
          ...
          <div style={{ marginTop: '4rem', fontSize: '1rem', color: 'var(--text-secondary)', textAlign: 'center', backgroundColor: 'var(--bg-secondary)', padding: '2rem', borderRadius: '1rem' }}>
            <p style={{ margin: 0 }}><strong>BH = Business hours, Monday to Friday, 9am to 6pm ET.</strong> SLAs are response targets, not resolution guarantees. Final SLAs confirmed in the retainer agreement.</p>
          </div>
        </div>
      </section>
      ...
      <section className={`${homeStyles.sectionAbout} scroll-section`} style={{ padding: '10rem 0', backgroundColor: 'var(--bg-secondary)' }}>
        <div className="container">
          ...
          <div style={{ marginTop: '4rem', display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center' }}>
            <Link href="/industries/professional-services/" className="btn btn-secondary">Professional Services Support &#8594;</Link>
            <Link href="/industries/manufacturing-distribution/" className="btn btn-secondary">Manufacturing & Distribution Support &#8594;</Link>
          </div>
        </div>
      </section>
      ...
      <section className={`${homeStyles.sectionAbout} scroll-section`} style={{ padding: '8rem 0', backgroundColor: 'var(--bg-secondary)', textAlign: 'center' }}>
        <div className="container">
          ...
          <Link href="/book-a-fit-call/?practice=zoho-managed" className="btn btn-primary btn-lg">Book a fit call &#8594;</Link>
        </div>
      </section>
