...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. If you already run Snowflake, Databricks, Redshift, BigQuery, Synapse, or Postgres as warehouse, we extend and modernize rather than replatforming for the sake of it."
      }
    },
    {
      "@type": "Question",
